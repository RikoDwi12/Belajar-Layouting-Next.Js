...
//   return (
//     <div className="flex flex-col bg-slate-600 w-full h-[308px] md:h-[648px] p-10 justify-center items-center sm:p-4 md:p-6 lg:p-8 no-warp">
//       {/* <Image
//         src="/pp.webp"
...
//           {data.date}
//         </p>
//         <div className="flex bg-white justify-center item-center gap-[4px] md:gap-[8px] mt-[9px] md:mt-[24px]">
...
//         <p className="text-center text-[12px] md:text-[20px]">{data.desc}</p>
//       </div>
//     </div>
//   );
// }
