    ...
    <>
      ...
      <div className="bg-[url('/bgpp.svg')] flex flex-col bg-slate-600 w-full h-[308px]  md:h-[calc(100vh-72px)] p-10 justify-center items-center sm:p-4 md:p-6 lg:p-8 no-warp bg-cover">
        <div className="">
          ...
          <p className="text-center mt-[16px] mb-[8px] md:mb-[24px] text-[12px] md:text-[20px]">
            sdisjdisjiajsia999
          </p>
        ...
        <div className=" mt-[32px] md:mt-[72px] ">
          <p className="text-center text-[12px] md:text-[20px]">sasaasa</p>
        </div>
      </div>
      {/* <Article
        title="Salmon Health Benefits"
      ...
      <div className="flex flex-col bg-white w-full px-[16px] md:px-[162px] pt-[24px] md:pt-[80px] pb-[36px]">
        <div className="">
          ...
          <p className="text-[16px] md:text-[32px] text-black">
            Rich in omega-3 fatty acids
          </p>
          <p className="text-[12px] md:text-[20px] text-black">
          ...
          <button className="bg-[#F1F1F1] text-[#9B9B9B] mt-[16px] py-[4px] rounded-full hidden md:flex justify-center items-center  ">
            read more
          </button>
        </div>
